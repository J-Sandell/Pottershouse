			...
			<div className="row">
				<div className="col">
					...
					<div className="prayer">
						<img className="pictures" src="/assets/prayerscreen.jpg" alt="prayer screen" height={350} width={350} ></img>
					</div>
			...
			<div className="row mt-3">
				<div className="col">
					...
					<ul>
						...
						<li>The Holy Spirit is God, the Lord, and giver of life, who was active in the Old Testament, and given to the Church in fullness at Pentecost. He empowers the saints for service and witness, cleanses man from the old nature, and conforms us to the image of Christ.</li>
						<li>The baptism in the Holy Spirit with evidence of speaking in tongues, subsequent to conversion, releases the fullness of the Spirit, and is evidenced by the fruits and gifts of the Holy Spirit.</li>
						<li>In the Bible containing the Old and New Testament is alone the only infallible, inspired Word of God, and that its authority is ultimate, final, and eternal. It cannot be added to, subtracted from, or superseded in any regard. The Bible is the source of all doctrine, instruction, correction, and reproof. It contains all that is needed for guidance in godliness and practical Christian conduct.</li>
						<li>Christ's vicarious death on the cross paid the penalty for the sins of the whole world. Its benefits of healing (body, soul, and spirit) are provided for in the atonement as well.</li>
						<li>That salvation is a free gift of God, based on the merits of the death of His Son, and is appropriated by faith. Salvation is affected by person repentance, belief in the Lord Jesus (justification), and personal acceptance of Him into one's life as Lord and Savior (regeneration).</li>
						<li>The Christian life is to be one of consecration, devotion, and holiness. The shortcomings of the individual are because of the still progressing sanctification of the saints. The Christian life is filled with trials, tests, and warfare against a spiritual enemy. For those abiding in Christ until their deaths or His return, the promises of eternal blessing in the presence of God are assured.</li>
